...
_NAME_TO_EVENT_TYPE: dict[str, str] = {
    ...
    "agent_rag_reformulation": "tool_result",
    "agent_rule_boundary": "warning",
    "agent_evidence_priority": "tool_result",
    "agent_repair_check": "warning",
    "agent_chapter_consistency": "warning",
    "scc_request": "status",
