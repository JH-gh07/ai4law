...
Reference: docs/archive/design-provenance/认证标准合同路径.md Section 1
"""
...
from backend.domains.cn.scc_review.schema import LegalBasis, PathDiagnosisInput, PathDiagnosisResult, PathType
