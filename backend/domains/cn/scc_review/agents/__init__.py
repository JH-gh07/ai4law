...
Reference: docs/archive/design-provenance/认证标准合同路径.md
"""
...
def create_scc_agents(llm_client: LLMClient | None = None) -> dict[str, SCCAgentBase]:
    ...
    from backend.domains.cn.scc_review.agents.path_diagnosis_agent import PathDiagnosisAgent
    from backend.domains.cn.scc_review.agents.data_classification_agent import DataClassificationAgent
    from backend.domains.cn.scc_review.agents.contract_review_agent import ContractReviewAgent
    from backend.domains.cn.scc_review.agents.evidence_verification_agent import EvidenceVerificationAgent
    from backend.domains.cn.scc_review.agents.legal_basis_review_agent import LegalBasisReviewAgent
    from backend.domains.cn.scc_review.agents.report_review_agent import ReportReviewAgent
    from backend.domains.cn.scc_review.agents.rag_planning_agent import RAGPlanningAgent
    from backend.domains.cn.scc_review.agents.clarification_agent import ClarificationAgent
    from backend.domains.cn.scc_review.agents.explanation_agent import ExplanationAgent
