...
Architecture per docs/archive/design-provenance/dpia.md Section 12 (3-phase rollout):
...
Reference: docs/archive/design-provenance/dpia.md — DPIA Agent 总体接入位置 & 各 Agent 具体处理逻辑
"""
...
def create_dpia_agents(llm_client: LLMClient | None = None) -> dict[str, DPIAAgentBase]:
    ...
    from backend.domains.eu.dpia.agents.dpia_need_agent import DPIANeedAgent
