...
Reference: docs/archive/design-provenance/dpia.md Section 4 — GDPR Article 35(7)(b)
"""

from __future__ import annotations

from backend.domains.eu.dpia.agents import DPIAAgentBase
from backend.domains.eu.dpia.schema import NecessityFinding, NecessityFindings
