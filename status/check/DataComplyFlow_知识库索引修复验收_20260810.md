...
```
  质量审计: 35/35 项全部通过 (0 问题)
  
  P0-1 EU 噪音: 839 → 0 (100% 清除)
  P0-2 CPRA:    12 → 83 独立条款 (目标 ≥80)
  P0-3 GDPR:    13 → 99 独立条款 (目标 ≥80, PDF 提取)
  P1-1 CN短chunk: 50.7% → 11.6% (目标 <30%)
  P1-2 cn_pipia: 0 → 71 条目
  P1-3 cn_assessment: 44 → 254 条目
  P1-4 US 噪音: 270 → 0
  P1-5/6 source_cap=3: 已实现
```
...
| Index | Entries | Size |
|------|------:|------:|
| legal_index_cn | 680 | 1,244 KB |
| legal_index_eu | 402 | 1,113 KB |
| legal_index_us | 197 | 464 KB |
| standard_clause_index_* | 11 | 14 KB |
| template_index_* | 17 | 17 KB |
| testcase_index_* | 12 | 11 KB |
| workflow_index_* | 18 | 20 KB |
| **TOTAL** | **1,337** | **2,883 KB** |

### 模块级分布

```
EU: eu_scc=101, eu_bcr=101, eu_dpia=99, eu_tia=101
US: us_cpra=90, us_vendor_review=90, us_eo14117=17
