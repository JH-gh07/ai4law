...
As shown in Figure 1, the Privacy                                   The Core provides an increasingly granular set
Framework is composed of three                                      of activities and outcomes that enable an
parts: Core, Profiles, and                                          organizational dialogue about managing privacy
Implementation Tiers. Each                                          risk
component reinforces how
organizations manage privacy risk
                                                                                          Profiles are a selection of
through the connection between
                                                                                          specific Functions,
business or mission drivers,                                                              Categories, and
organizational roles and                                                                  Subcategories from the
responsibilities, and privacy                                       CURRENT               Core that an organization
protection activities. As further                                             TARGET
                                                                                          has prioritized to help it
explained in section 2:                                                                   manage privacy risk
    •   The Core is a set of privacy
        protection activities and                              Implementation Tiers support communication
        outcomes that allows for                               about whether an organization has sufficient
        communicating prioritized                              processes and resources in place to manage
        privacy protection                                     privacy risk and achieve its Target Profile
        activities and outcomes                  Figure 1: Core, Profiles, and Implementation Tiers
...
communicate and manage cybersecurity                   Cybersecurity                             Privacy
risk. [1] While managing cybersecurity                       Risks                                Risks
                                                                              cyber
risk contributes to managing privacy risk,            associated with                        associated with
                                                                            security-
it is not sufficient, as privacy risks can              cybersecurity                        privacy events
                                                                             related
also arise by means unrelated to                   incidents arising from privacy           arising from data
cybersecurity incidents, as illustrated by         loss of confidentiality, events              processing
Figure 2. Having a general understanding                 integrity, or
of the different origins of cybersecurity                 availability
and privacy risks is important for
determining the most effective solutions to
address the risks.                                       Figure 2: Cybersecurity and Privacy Risk
...
The Privacy Framework describes these data operations in the singular as a data action and collectively
      ...
      Data Action       processing can be expressed in various ways, but NIST describes them as
    A data life cycle   ranging from dignity-type effects such as embarrassment or stigmas to more
  operation, including, tangible harms such as discrimination, economic loss, or physical harm. 6
      but not limited to
    collection, retention,   The basis for the problems that individuals may experience can vary. As
    logging, generation,     depicted in Figure 2, problems arise as an adverse effect of data processing
    transformation, use,     that organizations conduct to meet their mission or business objectives. An
     disclosure, sharing,    example is the concerns that certain communities had about the installation of
      transmission, and      “smart meters” as part of the Smart Grid, a nationwide technological effort to
           disposal.         increase energy efficiency. 7 The ability of these meters to collect, record, and
     Data Processing         distribute highly granular information about household electrical use could
...
between privacy risk and organizational risk.
            ...
            arises from data         experiences direct impact           resulting impact
               processing              (e.g., embarrassment,     (e.g., customer abandonment,
                                     discrimination, economic    noncompliance costs, harm to
                                                 loss)           reputation or internal culture)
...
10
     See European Data Protection Supervisor (2019) Necessity & Proportionality. Available at
...
prioritize and respond to privacy risk in different ways, depending on the potential impact to individuals
...
11
     See NIST Special Publication (SP) 800-39, Managing Information Security Risk: Organization, Mission, and
...
NIST Privacy Framework                                                                           January 16, 2020
     ...
     •   Appendix A presents the Privacy Framework Core in a tabular format: Functions, Categories,
         and Subcategories.
...
provides an increasingly granular set of           Identify-P
activities and outcomes that enable a
dialogue about managing privacy risk.              Govern-P
As depicted in Figure 4, the Core
comprises Functions, Categories, and                Control-P
Subcategories.
The Core elements work together:                Communicate-P
     •   Functions organize
         foundational privacy activities         Protect-P
...
12
     The “-P” at the end of each Function name indicates that it is from the Privacy Framework in order to avoid
...
leveraged to further support the
management of risks associated with
cybersecurity-related privacy events
by using the Detect, Respond, and                                                   Privacy
                                              Cybersecurity
Recover Functions. Alternatively,                               Cybersecurity-       Risks
                                                  Risks        related privacy
organizations may use all five of the
Cybersecurity Framework Functions in            IDENTIFY            events        IDENTIFY-P
conjunction with Identify-P, Govern-P,          PROTECT           PROTECT-P       GOVERN-P
Control-P, and Communicate-P to                  DETECT             DETECT        CONTROL-P
collectively address privacy and               RESPOND             RESPOND      COMMUNICATE-P
cybersecurity risks. Figure 5 uses the          RECOVER            RECOVER
...
varying combinations to manage                                 Privacy Risks
...
The Privacy Framework does not                                                         PROFILES
prescribe Profile templates to allow                                               Identify-P

                                                                          CURRENT
for flexibility in implementation.                    CORE
                                                                                   Govern-P
Under the Privacy Framework’s risk-
based approach, organizations may              Identify-P                          Protect-P
not need to achieve every outcome              Govern-P
or activity reflected in the Core.                                                 Identify-P
When developing a Profile, an                  Control-P
                                                                                    Govern-P
organization may select or tailor the       Communicate-P
                                                                          TARGET
Functions, Categories, and                                                          Control-P
                                               Protect-P
Subcategories to its specific needs,                                            Communicate-P
including developing its own
additional Functions, Categories,                                                   Protect-P
and Subcategories to account for
unique organizational risks. An               Figure 6: Relationship Between Core and Profiles
...
and procedures, or as traceability                           Tier selection and Profile development
...
organizational levels as it connects             Senior               Business/Process         Implementation/
                                            Executive Level              Manager    Level      Operations Level
senior executives, who can
communicate an organization’s             Responsibilities:           Responsibilities:       Responsibilities:
privacy values and risk tolerance, to      • Express  mission          •  Develop              • Implement
                                             priorities, risk             Profiles               Profiles
those at the business/process                tolerance,
manager level, who can collaborate           organizational            • Allocate budget       • Monitor
                                             privacy values,           • Inform Tier             progress
on the development and                       and budget                   selection            • Conduct privacy
implementation of governance               • Accept/decline
                                             risk decisions                                      risk assessments
policies and procedures that support
organizational privacy values. These
policies and procedures can then be                     Privacy posture, changes in risk, implementation
communicated to those at the                              progress, and incident management activities
implementation/operations level,                           C O M M U N I C A T I O N
...
13
     See, e.g., Organisation for Economic Co-operation and Development (OECD) (2013) OECD Guidelines on the
...
ecosystem. An organization can use the Identify-P and Govern-P                 to get “ready.”
...
risk assessments) provide a foundation for completing the Profiles             implementing the action
in “Set.”                                                                      plan.
...
14
     See, e.g., NIST SP 800-37, Rev. 2, Risk Management Framework for Information Systems and Organizations: A
...
15
     For additional information, see the “Prepare” step, Section 3.1, NIST SP 800-37, Rev. 2 [7].
...
16
     NIST SP 800-37, Rev. 2 [7] provides additional information on steps to execute on the action plan, including
...
data processing ecosystem, which can
                                                                      Public/
affect not only its legal obligations, but                         Government
also the measures it may take to manage                              Services
privacy risk. As depicted in Figure 8, the          Manufacturer                      Individuals
data processing ecosystem encompasses
a range of entities and roles that may
have complex, multi-directional
relationships with each other and             Supplier or                                          Civil
                                                Service                                           Society
individuals. Complexity can increase           Provider
when entities are supported by a chain
of sub-entities; for example, service
providers may be supported by a series              Business
of service providers, or manufacturers             Associates                                Research/
                                                  or Partners                                Education
may have multiple component suppliers.
Figure 8 displays entities as having                                          Commercial
                                                                                Product/
distinct roles, but some may have                               Developer       Services
...
NIST Privacy Framework                                                                                                         January 16, 2020
   ...
   organizational        is understood and informs the management        ID.IM-P2: Owners or operators (e.g., the organization or third parties
...
NIST Privacy Framework                                                                                                            January 16, 2020
   ...
   Function              Category                                        Subcategory
                         ...
                         Management (ID.DE-P): The                       processes, and procedures are identified, established, assessed,
...
NIST Privacy Framework                                                                                                             January 16, 2020
   ...
   Function               Category                                         Subcategory
                          ...
                          management of privacy risk.                      change.
                                                                           ...
                                                                           in place.
   CONTROL-P (CT-         Data Processing Policies, Processes, and         CT.PO-P1: Policies, processes, and procedures for authorizing data
   P): Develop and        Procedures (CT.PO-P): Policies, processes,       processing (e.g., organizational decisions, individual consent), revoking
   implement              and procedures are maintained and used to        authorizations, and maintaining authorizations are established and in
   appropriate            manage data processing (e.g., purpose,           place.
   activities to enable   scope, roles and responsibilities in the data    CT.PO-P2: Policies, processes, and procedures for enabling data
   organizations or       processing ecosystem, and management             review, transfer, sharing or disclosure, alteration, and deletion are
   individuals to         commitment) consistent with the                  established and in place (e.g., to maintain data quality, manage data
   manage data with       organization’s risk strategy to protect          retention).
   sufficient             individuals’ privacy.                            CT.PO-P3: Policies, processes, and procedures for enabling individuals’
   granularity to                                                          data processing preferences and requests are established and in place.
...
NIST Privacy Framework                                                                                                            January 16, 2020
   ...
   (CM-P): Develop        Procedures (CM.PO-P): Policies, processes,       communicating data processing purposes, practices, and associated
...
NIST Privacy Framework                                                                                                         January 16, 2020
   ...
   safeguards.           commitment), processes, and procedures         PR.PO-P3: Backups of information are conducted, maintained, and
                         ...
                         and Access Control (PR.AC-P): Access to        revoked, and audited for authorized individuals, processes, and
                         ...
                         Data Security (PR.DS-P): Data are              PR.DS-P1: Data-at-rest are protected.
...
This appendix defines selected terms used for the purposes of this publication.
 Attribute Reference         A statement asserting a property of a subscriber without necessarily
 (NIST SP 800-63-3 [8])      containing identity information, independent of format. For example, for
                             the attribute “birthday,” a reference could be “older than 18” or “born in
                             December.”

 Attribute Value             A complete statement asserting a property of a subscriber, independent
 ...
 (Function)                  and individuals to have a reliable understanding and engage in a dialogue
                             about how data are processed and associated privacy risks.

 Confidentiality             Preserving authorized restrictions on information access and disclosure,
 (44 U.S.C. [13])            including means for protecting personal privacy and proprietary
                             information.
 ...
 (Framework for              A cybersecurity event that has been determined to have an impact on the
 Improving Critical          organization prompting the need for response and recovery.
 Infrastructure
 Cybersecurity [1])
...
NIST Privacy Framework                                                                    January 16, 2020
 ...
 Data Action (Adapted        A system/product/service data life cycle operation, including, but not
 from NIST IR 8062 [5])      limited to collection, retention, logging, generation, transformation, use,
 ...
 Data Processing             The collective set of data actions (i.e., the complete data life cycle,
 (Adapted from NIST IR       including, but not limited to collection, retention, logging, generation,
 8062 [5])                   transformation, use, disclosure, sharing, transmission, and disposal).

 Data Processing             The complex and interconnected relationships among entities involved in
 Ecosystem                   creating or deploying systems, products, or services or any components
                             that process data.

 Disassociability (Adapted   Enabling the processing of data or events without association to
 from NIST IR 8062 [5])      individuals or devices beyond the operational requirements of the
                             system.
 ...
 (44 U.S.C. [13])            includes ensuring information non-repudiation and authenticity.
 ...
 Manageability (Adapted      Providing the capability for granular administration of data, including
 from NIST IR 8062 [5])      alteration, deletion, and selective disclosure.

 Metadata (Adapted from      Information describing the characteristics of data.
 NIST SP 800-53 [10])
 ...
 Predictability (Adapted     Enabling reliable assumptions by individuals, owners, and operators
 from NIST IR 8062 [5])      about data and their processing by a system, product, or service.
...
NIST Privacy Framework                                                                  January 16, 2020
 ...
 Privacy Breach (Adapted    The loss of control, compromise, unauthorized disclosure, unauthorized
 from OMB M-17-12 [9])      acquisition, or any similar occurrence where (1) a person other than an
 ...
 Privacy Control (Adapted   The administrative, technical, and physical safeguards employed within
 from NIST SP 800-37 [7])   an organization to satisfy privacy requirements.
 ...
 Privacy Risk               A cross-organizational set of processes for identifying, assessing, and
 Management                 responding to privacy risks.
 ...
 Provenance (Adapted        Metadata pertaining to the origination or source of specified data.
 from NIST IR 8112 [11])

 Risk                       A measure of the extent to which an entity is threatened by a potential
 (NIST SP 800-30 [12])      circumstance or event, and typically a function of: (i) the adverse impacts
 ...
 Risk Tolerance             The level of risk or degree of uncertainty that is acceptable to
 (NIST SP 800-39 [6])       organizations.
...
product, or service.
                                              Table 3: Privacy Engineering and Security Objectives 18

                                                                                                  Principal Related
                           Objective            Definition                                        Functions from the
                                                                                                  Privacy Framework Core
                           Predictability       Enabling reliable assumptions by individuals,     Identify-P, Govern-P,
                                                owners, and operators about data and their        Control-P, Communicate-


 Privacy Engineering
                                                processing by a system                            P, Protect-P
                           Manageability        Providing the capability for granular             Identify-P, Govern-P,
                                                administration of data, including collection,     Control-P


      Objectives
                                                alteration, deletion, and selective disclosure
                           Disassociability     Enabling the processing of data or events         Identify-P, Govern-P,
                                                without association to individuals or devices     Control-P
                                                beyond the operational requirements of the
                                                system
                           Confidentiality      Preserving authorized restrictions on             Identify-P, Govern-P,
                                                information access and disclosure, including      Protect-P
     ...
     Security Objectives
                           ...
                           Integrity            Guarding against improper information             Identify-P, Govern-P,
                                                modification or destruction; includes ensuring    Protect-P
                                                information non-repudiation and authenticity
                           Availability         Ensuring timely and reliable access to and use    Identify-P, Govern-P,
                                                of information                                    Protect-P
...
18
              The privacy engineering objectives are adapted from NIST IR 8062 [5]. The security objectives are from NIST SP
              800-37, Rev. 2 [7].
                                                                        34
NIST Privacy Framework                                                                           January 16, 2020
...
20
     See NIST SP 800-30, Rev. 1, Guide for Conducting Risk Assessments [12] at p. 8.
21
     As part of its PRAM, NIST has created an illustrative catalog of problematic data actions and problems for
...
NIST Privacy Framework                                                                             January 16, 2020
              ...
              consider the best means of internalizing impact to individuals in order to appropriately
...
23
     The NIST PRAM uses organizational costs such as non-compliance costs, direct business costs, reputational
     costs, and internal culture costs as drivers for considering how to assess individual impact. Id. at Worksheet 3,
     Impact Tab.
24
     See NIST SP 800-30, Rev. 1, Guide for Conducting Risk Assessments at [12] p. 14.
25
...
28
     See NIST SP 800-37, Rev. 2 [7].
29
     See NIST SP 800-53 as updated [10].
                                                          36
NIST Privacy Framework                                                                  January 16, 2020
